...
export const baseConfig = registerAs('baseConfig', () => ({
    ...
    loggingConfig = registerAs('logginConfig', () => ({
        host: process.env.AIVEN_OPENSEARCH_HOST,
        username: process.env.AIVEN_OPENSEARCH_USERNAME,
        password: process.env.AIVEN_OPENSEARCH_PASSWORD,
        port: process.env.AIVEN_OPENSEARCH_PORT,
        logLevel:process.env.LOGS_OPENSEARCH_LEVEL
    }))